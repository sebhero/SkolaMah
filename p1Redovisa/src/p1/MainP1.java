...
public class MainP1 {
	...
	public static void testSearchSort() {
        ...
        setList(list, 50, 79);
        test(Searching.binearSearch(list, new Long(60))==10, "binarySearch(list,60)", "binarySearch(list,60)");
        test(Searching.binearSearch(list, new Long(100))<0, "binarySearch(list,100)", "binarySearch(list,100)");
        shuffle(list);
