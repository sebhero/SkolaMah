...
public class PriorityQueue<E> implements Queue<E> {
	...
	public PriorityQueue(int initialCapacity) {
		queue = new ArrayHeap<>(initialCapacity);
	}
	...
	public PriorityQueue(int initialCapacity, Comparator<E> comparator) {
		queue = new ArrayHeap<>(initialCapacity, new PriorityQueueComparator<>(comparator));
	}
	...
	public void enqueue(E data) {
		queue.insert(new PriorityQueueElement<>(data));
