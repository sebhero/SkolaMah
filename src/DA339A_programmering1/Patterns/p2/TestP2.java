    ...
    public void programLoop() {
        ...
        do {
            try {
                ...
                switch(choice) {
                    case 1 : runMain("DA339A_programmering1.Patterns.p2.Exercise2a"); break;
                    case 2 : runMain("DA339A_programmering1.Patterns.p2.Exercise2b"); break;
                    case 3 : runMain("DA339A_programmering1.Patterns.p2.StartRace"); break;
                }
            } catch (Exception e) {
