...
public class TestP5 {
    public static void testMethod1() throws Exception {
        Class cls1 = Class.forName("DA339A_programmering1.Patterns.p5.SimpleDice");
        Class cls2 = Class.forName("DA339A_programmering1.Patterns.p5.TestDice");
...
//        method.invoke(null, new Object[]{constr.newInstance(new Object[]{new Integer(4)}),new Integer(1000000)});
    ...
    public static void testMethod2() throws Exception {
        Class cls1 = Class.forName("DA339A_programmering1.Patterns.p5.OrdinaryPlayer");
        Class cls2 = Class.forName("DA339A_programmering1.Patterns.p5.Cheater");
        Class cls3 = Class.forName("DA339A_programmering1.Patterns.p5.TestDice");
        Class cls4 = Class.forName("DA339A_programmering1.Patterns.p5.SimpleDice");
        ...
        Method method = cls3.getDeclaredMethod("test", new Class[]{Player.class,int.class});
    ...
    public void programLoop() {
        ...
        while(choice!=0) {
            try {
                switch(choice) {
                    case 1 : runMain("DA339A_programmering1.Patterns.p5.TestSimpleDice"); break;
                    case 2 : runMain("DA339A_programmering1.Patterns.p5.TestOrdinaryPlayer"); break;
                    case 3 : testMethod1(); break;
                    case 4 : runMain("DA339A_programmering1.Patterns.p5.TestCheater"); break;
                    case 5 : testMethod2(); break;
                    case 6 : runMain("DA339A_programmering1.Patterns.p5.TestProbabilityDice"); break;
                }
            } catch (Exception e) {
