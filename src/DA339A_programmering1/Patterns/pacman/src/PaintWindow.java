...
/**
 * I ett f�nster av typen PaintWindow kan man visa bilder och rita linjer, ellipser 
 * och rektanglar. N�r f�nstret skapas kan man ange en bild som ska vara bakgrundsbild.
...
public class PaintWindow extends JFrame {
    ...
    // Ett f�nster med vit bakgrund, 600x400 pixlar stort skapas
    public PaintWindow() {
        this(null);
    }
    ...
    public void addMyKeyListener (KeyListener listener) {				//Added to get keylistener to work...
