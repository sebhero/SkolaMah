package DA339A_programmering1.Patterns.skola.lab3.upg5f;

import DA339A_programmering1.Patterns.skola.lab3.upg5e.PaintWindow;
...
public class Program5f {
    ...
    public void demo1() {
        ...
        URL summerPath = this.getClass().getResource("/DA339A_programmering1/Patterns/res/summer.jpg");
        URL winterPath = this.getClass().getResource("/DA339A_programmering1/Patterns/res/winter.jpg");
