...
public class Laboration12 {
    ...
    public void exercise6() {
        ...
        while( svenska!=null && !svenska.equals("slut") ) {
	        ...
	        javax.swing.JOptionPane.showMessageDialog(null,MessageFormat.format("{0} ger resultatet {1}", svenska, engelska));
    ...
    public void exercise7() {
	    ...
	    String stad, land = JOptionPane.showInputDialog("Skriv in ett land?");

	    while (land != null && !land.equals("slut")) {
		    stad = tree.get(land);
		    javax.swing.JOptionPane.showMessageDialog(null,MessageFormat.format("{0} ger resultatet {1}", land, stad));
		    land= javax.swing.JOptionPane.showInputDialog( "Skriv in ett land?" );
	    }
	...
	private void exercise21() {
		...
		Print pa = new Print();
//		bst.traverse(pa);
		bst.traverse((v)-> System.out.print(v+" "));
	...
	private void exercise13() {
		...
		tree.put(n5.key,n5.value);
		tree.put(n4.key,n4.value);
		tree.put(n3.key,n3.value);
		tree.put(n2.key,n2.value);
		tree.put(n1.key,n1.value);
		root.showAVL();
//		root = rotateRight(root);
//		root.showAVL();
	}
