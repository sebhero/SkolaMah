...
public class Race {
     ...
     *
     * @param window the paintwindow where the race is displayed
     * @param car1   first car in the game
     * @param car2   second car in the game
     */
    ...
    public void action() {
        ...
        while (true) {
            ...
            pw.showImage(car2Text, text2Pos+10, 50);
            ...
            car1Text.setText(car1.getX() - GOAL_LINE_POS);
            car2Text.setText(car2.getX() - GOAL_LINE_POS);
