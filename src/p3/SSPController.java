...
public class SSPController {
     ...
     * @param viewer the view to display game results
     */
    ...
    private void updateView(int playerChoice, int cpuChoice) {
        ...
        //TODO add display in view values.
        this.viewer.updateWithNewStats(this.playerWon,this.cpuWon,playerChoice,cpuChoice);
    }

    /**
     * Check if there is a winner
     * @param playerWon times player has won
     * @param cpuWon times cpu has won
     ...
     * @param sspUserInput the user input object
     */
