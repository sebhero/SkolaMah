...
public class SSPViewer extends JPanel{
     ...
     * @param playerWon many times player won
     * @param cpuWon many times cpu won
     * @param playerChoice what the play picked
     * @param cpuChoice what the cpu picked
     */
     ...
     * @param choice the int value of the choice
