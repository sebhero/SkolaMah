...
public class Ghost extends PacOrGhost
{
    ...
    public Ghost(SquareItem pos)
    {
        ...
        pos.setSomeoneAtPos (this);
         ...
         // Load the images.
        //pacman/closedMouthD.png
        normalImage = new ImageIcon(this.getClass().getResource("/pacman/ghostNormal.jpg"));
        scaredImage = new ImageIcon(this.getClass().getResource("/pacman/ghostScared.jpg"));
    }                                
