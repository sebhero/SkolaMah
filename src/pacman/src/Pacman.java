...
//        URL imgPath1 = StartRace.class.getResource("/p2/CarBlue.GIF");
         // Load the images.
        openMouthImageL = 	new ImageIcon(this.getClass().getResource("/pacman/openMouthL.png"));
        closedMouthImageL = new ImageIcon(this.getClass().getResource("/pacman/closedMouthL.png"));
        openMouthImageR = 	new ImageIcon(this.getClass().getResource("/pacman/openMouthR.png"));
        closedMouthImageR = new ImageIcon(this.getClass().getResource("/pacman/closedMouthR.png"));
        openMouthImageU = 	new ImageIcon(this.getClass().getResource("/pacman/openMouthU.png"));
        closedMouthImageU = new ImageIcon(this.getClass().getResource("/pacman/closedMouthU.png"));
        openMouthImageD = 	new ImageIcon(this.getClass().getResource("/pacman/openMouthD.png"));
        closedMouthImageD = new ImageIcon(this.getClass().getResource("/pacman/closedMouthD.png"));
